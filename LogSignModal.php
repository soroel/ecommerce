    ...
    <div class="modal-header">
      ...
      <div class="modal-body">
              ...
              <ul class="nav nav-pills">
                  <li class="active"><a  style="background-color:green"class="btn btn-default check_out" href="#home" data-toggle="tab">Login</a>
                  </li>
                  <li><a style="background-color:green"class="btn btn-default check_out" href="#profile" data-toggle="tab">Sign Up</a>
                  </li>
                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a href="https://bit.ly/2LPn9Wu">Datapedia Global Consultation</a></p>
                        </div>
                    </div> 
                  </div>
                  <!-- end login panel -->
                      ...
                      <!-- <h4>Customer Details</h4>  --> 
                           ...
                           <form  class="form-horizontal span6" action="customer/controller.php?action=add" onsubmit="return personalInfo();" name="personal" method="POST" enctype="multipart/form-data">
                                <div class="panel panel-pup">
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a style="color:green"class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of Datapepedia Global Consultation.</small>
                                    ...
                                    <div class="panel-footer">
                                        <p align="left">&copy; <a style="color:green"href="#">Datapedia Global Consultation</a></p>
                                    </div> 
                            </div> 
                            <!-- end panel sign up -->
                        </form>  
