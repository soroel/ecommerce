<section id="cart_items">
    <div style="color:green" class="container">
      <div class="breadcrumbs">
        <ol class="breadcrumb">
          <li><a style="background-color:green" href="#">Home</a></li>
...
?>
                         ...
                         <thead> 
                          <tr class="cart_menu"> 
                             <td style="background-color:green">Product</td>
                             <td style="background-color:green">Description</td>
                             <td style="background-color:green" width="15%" >Price</td>
                             <td style="background-color:green" width="15%" >Quantity</td> 
                             <td style="background-color:green"  width="15%" >Total</td>  
                          </tr>
                         </thead>  
                                  ...
                                  <br/> 
                                        <?php    
                                            ...
                                            if (isset($_SESSION['CUSID'])){  
                                              ...
                                              echo ' <a style="color:green"  href="'.web_root. 'customer/controller.php?action=addwish&proid='.$result->PROID.'" title="Add to wishlist">Add to wishlist</a>
             ';
                                           
                                             }else{
                                               echo   '<a style="color:green" href="#" title="Add to wishlist" class="proid"  data-target="#smyModal" data-toggle="modal" data-id="'.  $result->PROID.'">Add to wishlist</a>
             ';
                                            } 
...
<section id="do_action">
   ...
   <a style="background-color:green" href="index.php?q=product" class="btn btn-default check_out pull-left ">
   ...
   Add New Order
     ...
     <?php    
                  ...
                  if (isset($_SESSION['CUSID'])){  
                    ...
                    echo '<button style="background-color:green" type="submit"  name="proceed" id="proceed" class="btn btn-default check_out btn-pup pull-right">
                            Proceed And Checkout
                            <i class="fa  fa-arrow-right fa-fw"></i>
                            </button>';
                 
                   }else{
                     echo   '<a style="background-color:green"data-target="#smyModal" data-toggle="modal" class="btn btn-default check_out signup pull-right" href="">
                              Proceed And Checkout
                              <i class="fa  fa-arrow-right fa-fw"></i>
                              </a>';
                  } 
