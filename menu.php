                  ...
                  <ul class="nav nav-pills nav-justified">
                   <li>
                            ...
                            if (isset($_SESSION['CUSID'])){  
                              ...
                              echo ' <a style="background-color:green" href="'.web_root. 'customer/controller.php?action=addwish&proid='.$result->PROID.'" title="Add to wishlist"><i class="fa fa-plus-square"></i>Add to wishlist</a></a>
                            ';

                             }else{
                               echo   '<a style="background-color:green" href="#" title="Add to wishlist" class="proid"  data-target="#smyModal" data-toggle="modal" data-id="'.  $result->PROID.'"><i class="fa fa-plus-square"></i>Add to wishlist</a></a>
                            ';
                            }  
                            ?>
