...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                ...
                <li><a href="#"><i class="fa fa-envelope"></i> innovationdev404@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                <li><a style="color:green" href="<?php echo web_root;?>" class="active">Home</a></li>
                <li class="dropdown"><a style="color:green" href="#">Shop<i class="fa fa-angle-down"></i></a>
                ...
                <li><a style="color:green" href="<?php web_root?>index.php?q=product">Products</a></li>
                <li><a style="color:green" href="<?php web_root?>index.php?q=contact">Contact</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="">Datapedia Global Consulation</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="">our members</a></span></p>
        </div>
      </div>
    </div>
